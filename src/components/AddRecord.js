...
const onSubmit = (event)=>{
  ...
  const kindnessNote = document.getElementById("kindess-note") ? document.getElementById("kindess-note").value : "";
  const graditudeNote = document.getElementById("graditude-note") ? document.getElementById("graditude-note").value : "";
  let exerciseLevel;
